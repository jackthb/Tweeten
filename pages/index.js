        ...
        <div className="inner container">
          ...
          <div className="main">
            <h1>
              ...
              <span className="slog"></span>
            </h1>
            <h1 className="alt">
              An intuitive and powerful Twitter experience built for those who
              get real work done
            </h1>
            <p>
              Get the most powerful TweetDeck experience without worrying about
              the limits. Ever.
            </p>
          </div>
            ...
            <ul className="feature-switcher">
              <li>
                <div className="meta">
                  ...
                  <span>
                    Being able to manage multiple accounts at the same time is
                    essential, and TweetDeck is built specifically for that.
                  </span>
                </div>
              </li>
              <li>
                <div className="meta">
                  ...
                  <span>
                    TweetDeck lets you schedule tweets, so that you can schedule
                    your tweets to be posted at the perfect time for your
                    followers.
                  </span>
                </div>
              </li>
              <li>
                <div className="meta">
                  ...
                  <span>
                    Search for GIFs, memes, hashtags, trends, breaking news, or
                    anything else on Tweeten in real-time with advanced filters
                    from TweetDeck.
                  </span>
                </div>
              </li>
              <li>
                <div className="meta">
                  ...
                  <span>
                    You can keep an eye on all the tweets that are being liked
                    by the people you are following, or whenever someone starts
                    to follow a new account on TweetDeck.
                  </span>
                </div>
              </li>
            </ul>
